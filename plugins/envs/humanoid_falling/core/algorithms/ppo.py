...
class RolloutBuffer:
    ...
    def compute_returns_and_advantages(
        ...
        for t in reversed(range(self.num_steps)):
            ...
            delta = (
                self.rewards[t] +
                gamma * next_value_t * next_non_terminal -
                self.values[t]
            )
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.policy = ActorCritic(
            ...
            actor_hidden=kwargs.get('actor_hidden', [512, 256, 128]),
            critic_hidden=kwargs.get('critic_hidden', [512, 256, 128]),
