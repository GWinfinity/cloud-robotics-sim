...
print("t_eq", thermal._source_t_eq.to_numpy().ravel()[:2])
print("alpha", thermal._source_alpha.to_numpy().ravel()[:2])
print("counts", thermal._source_cell_count.to_numpy().ravel()[:2])
print("sums", thermal._source_cell_sum.to_numpy().ravel()[:2])
