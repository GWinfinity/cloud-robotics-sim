...
s1 = thermal.add_source(
    Fixed((0.08, 0.08, 0.0)), temperature=1.0, radius=0.03, rate=1e6, heat_capacity=0.01
)
scene.build()
...
def E():  # noqa: N802
    ...
    return s1.heat_capacity * s1.temperature + float(
        cell_capacity * thermal.get_temperature().sum()
    )
